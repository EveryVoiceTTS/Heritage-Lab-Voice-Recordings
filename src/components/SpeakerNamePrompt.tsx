    ...
    <div className="min-h-screen bg-cream flex flex-col items-center justify-center p-6">
      <div className="max-w-md w-full">
        <div className="text-center mb-10">
          <img src={logoSrc} alt="Heritage Lab" className="h-14 mx-auto mb-6 object-contain" />
          <h1 className="text-3xl font-bold text-charcoal mb-2">Record Speech</h1>
          <p className="text-charcoal-light">Enter your 4-digit PIN to begin.</p>
        </div>

        <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-sm border border-cream-dark p-8">
          <div className="text-center mb-6">
            <div className="w-12 h-12 bg-sage-light/40 rounded-full flex items-center justify-center mx-auto mb-3">
              <svg className="w-6 h-6 text-forest-dark" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
              </svg>
            </div>
          </div>

          <label htmlFor="pin" className="block text-sm font-medium text-charcoal mb-2">
            Your PIN
          </label>
          <input
            ref={pinInputRef}
